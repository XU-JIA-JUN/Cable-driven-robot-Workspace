...
A2=A1*(-A(7,2)/A(7,1))+A2;
A1=A2*(-A1(8)/A2(8))+A1;

A1=A1*(1/A1(7));
A2=A2*(1/A2(8));
k=[A1 A2];
k1=[A1(1) A2(1);A1(2) A2(2)];

 setlmis([]);
 X1=lmivar(1,[1 0]);
 X2=lmivar(1,[1 0]);
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%5
 lmiterm([-1 1 1 X1],A(1,1),1);
 lmiterm([-1 1 1 X2],A(1,2),1);
 
 lmiterm([-2 1 1 X1],A(2,1),1);
 lmiterm([-2 1 1 X2],A(2,2),1);
 
 lmiterm([-3 1 1 X1],A(3,1),1);
 lmiterm([-3 1 1 X2],A(3,2),1);
 
 lmiterm([-4 1 1 X1],A(4,1),1);
 lmiterm([-4 1 1 X2],A(4,2),1);
 
 lmiterm([-5 1 1 X1],A(5,1),1);
 lmiterm([-5 1 1 X2],A(5,2),1);
 
 lmiterm([-6 1 1 X1],A(6,1),1);
 lmiterm([-6 1 1 X2],A(6,2),1);
 
 lmiterm([-7 1 1 X1],A(7,1),1);
 lmiterm([-7 1 1 X2],A(7,2),1);
 
 lmiterm([-8 1 1 X1],A(8,1),1);
 lmiterm([-8 1 1 X2],A(8,2),1);
 
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 
 lmiterm([9 1 1 X1],A(1,1),1);
 lmiterm([9 1 1 X2],A(1,2),1);
 lmiterm([-9 1 1 0],200);
 
 lmiterm([10 1 1 X1],A(2,1),1);
 lmiterm([10 1 1 X2],A(2,2),1);
 lmiterm([-10 1 1 0],200);
 
 lmiterm([11 1 1 X1],A(3,1),1);
 lmiterm([11 1 1 X2],A(3,2),1);
 lmiterm([-11 1 1 0],200);
 
 lmiterm([12 1 1 X1],A(4,1),1);
 lmiterm([12 1 1 X2],A(4,2),1);
 lmiterm([-12 1 1 0],200);
 
 lmiterm([13 1 1 X1],A(5,1),1);
 lmiterm([13 1 1 X2],A(5,2),1);
 lmiterm([-13 1 1 0],200);
 
 lmiterm([14 1 1 X1],A(6,1),1);
 lmiterm([14 1 1 X2],A(6,2),1);
 lmiterm([-14 1 1 0],200);
 
 lmiterm([15 1 1 X1],A(7,1),1);
 lmiterm([15 1 1 X2],A(7,2),1);
 lmiterm([-15 1 1 0],200);
 
 lmiterm([16 1 1 X1],A(8,1),1);
 lmiterm([16 1 1 X2],A(8,2),1);
 lmiterm([-16 1 1 0],200);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 lmis=getlmis;
